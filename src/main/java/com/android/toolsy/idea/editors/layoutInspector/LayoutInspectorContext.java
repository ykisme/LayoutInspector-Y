...
import com.android.layoutinspectory.model.LayoutFileData;
import com.android.layoutinspectory.model.ViewNode;
import com.android.layoutinspectory.model.ViewProperty;
import com.android.toolsy.idea.editors.layoutInspector.ptablelegacy.LITTableCellEditorProvider;
import com.android.toolsy.idea.editors.layoutInspector.ptablelegacy.LITableGroupItem;
import com.android.toolsy.idea.editors.layoutInspector.ptablelegacy.LITableRendererProvider;
import com.android.toolsy.idea.editors.layoutInspector.ui.RollOverTree;
import com.android.toolsy.idea.editors.layoutInspector.ui.ViewNodeActiveDisplay;
import com.android.toolsy.idea.editors.layoutInspector.ui.ViewNodeTreeRenderer;
...
import com.android.toolsy.property.ptablelegacy.PTable;
import com.android.toolsy.property.ptablelegacy.PTableItem;
import com.android.toolsy.property.ptablelegacy.PTableModel;
...
public class LayoutInspectorContext implements Disposable, DataProvider, ViewNodeActiveDisplay.ViewNodeActiveDisplayListener,
    ...
    private static final boolean DUMP_DISPLAYLIST_ENABLED = false;
    ...
    private class NodeRightClickAdapter extends MouseAdapter {
        ...
        public void mouseReleased(MouseEvent e) {
            onPopupTriggerCheck(e);
        }

        @Override
        public void mousePressed(@NotNull MouseEvent event) {
            onPopupTriggerCheck(event);
        }
    }
    ...
    public static void createNotification(@NotNull String message, @NotNull NotificationType type) {
        // 通过NotificationGroupManager获取已注册的通知组
