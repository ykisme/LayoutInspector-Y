 ...
 * @date 2022/6/30
 */
class LegacyLayoutInspectorEditorProviderV2 : FileEditorProvider, DumbAware {
    override fun accept(project: Project, file: VirtualFile): Boolean {
        return file.extension.orEmpty().equals(LegacyLayoutInspectorFileTypeV2.EXT_LAYOUT_INSPECTOR, true)
    }
